            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <!-- Usando a função asset() do Laravel para o logo da TechFlow -->
                        <img src="{{ asset('img/techflowads_logo.jpg') }}" alt="TechFlow Logo" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200 rounded-md" onerror="this.onerror=null;this.src='https://placehold.co/150x36/6366F1/FFFFFF?text=TechFlow+Logo';">
                    </a>
                </div>
